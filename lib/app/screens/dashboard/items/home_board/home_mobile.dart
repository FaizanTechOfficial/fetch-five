...
class HomeMobile extends GetView<DashboardController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => controller.screenLoading.value
        ? const Center(
                                ...
                                return GestureDetector(
                                  ...
                                  child: MovesDetails(
                                    backgroundImage: controller
                                                    ...
                                                    .opponentProfilePic !=
                                                null &&
                                            controller.yourTurnGame[index]
                                                .opponentProfilePic!.isNotEmpty
                                        ? NetworkImage(
                                ...
                                return GestureDetector(
                                  ...
                                  child: MovesDetails(
                                    backgroundImage: controller
                                                    ...
                                                    .opponentProfilePic !=
                                                null &&
                                            controller.theirTurnGame[index]
                                                .opponentProfilePic!.isNotEmpty
                                        ? NetworkImage(
                                ...
                                return GestureDetector(
                                  ...
                                  child: MovesDetails(
                                    backgroundImage: controller
                                                    ...
                                                    .opponentProfilePic !=
                                                null &&
                                            controller.completedTurnGame[index]
                                                .opponentProfilePic!.isNotEmpty
                                        ? NetworkImage(
